...
Result = foreach D generate xiaoiUDFs.GenerateRowKey('stat', 'newQuestion', '$date'), question;
--dump ansTypeResult;
--store ansTypeResult into '$hdfs_output_dir';
store Result into 'shmcc_stat' using org.apache.pig.backend.hadoop.hbase.HBaseStorage('stat_cf:question');
