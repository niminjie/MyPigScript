...
genData = foreach filterAns generate session_id;
disSess = distinct genData;
grpData	= group disSess all;
result = foreach grpData generate COUNT(disSess) as count;

ansTypeResult = foreach result generate xiaoiUDFs.GenerateRowKey('stat', 'visitUser', '$date'), count;
--dump ansTypeResult;
